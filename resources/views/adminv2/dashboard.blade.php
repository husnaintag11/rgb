        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome Sir Hashar Kamran Amin</h3>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card tale-bg">
                <div class="card-people mt-auto">
                    <img src="/adminv2/images/dashboard/people.svg" alt="people">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                        <li>
                            <div class="d-flex">
                                <img src="/adminv2/images/faces/face1.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="/adminv2/images/faces/face2.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="/adminv2/images/faces/face3.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="/adminv2/images/faces/face4.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="/adminv2/images/faces/face5.jpg" alt="user">
                                <div>
