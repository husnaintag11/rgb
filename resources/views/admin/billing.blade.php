                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="http://127.0.0.1:8000/assets/img/team-2.jpg"
                    ...
                    <div class="col-xl-6 mb-xl-0 mb-4">
                        <div class="card bg-transparent shadow-xl">
                            <div class="overflow-hidden position-relative border-radius-xl">
                                <img src="http://127.0.0.1:8000/assets/img/illustrations/pattern-tree.svg"
                                ...
                                <div class="card-body position-relative z-index-1 p-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                                            <img class="w-60 mt-2"
                                                src="http://127.0.0.1:8000/assets/img/logos/mastercard.png" alt="logo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                            <img class="w-10 me-3 mb-0"
                                                src="http://127.0.0.1:8000/assets/img/logos/visa.png" alt="logo">
                                            <h6 class="mb-0">
                                                ****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;5248
                                            </h6>
                                            <i class="material-icons ms-auto text-dark cursor-pointer"
