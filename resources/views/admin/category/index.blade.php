        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a href="sign_inl" class="nav-link text-body font-weight-bold px-0">
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Potery Create</h6>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $category->name}}</td>
                                    <td><a class="btn btn-outline-primary" href="{{route('cat.edit',$category->id)}}">Edit </a><a
                                            class="btn btn-outline-danger" href="{{route('cat.delete',$category->id)}}">Delete </a></td>
                                </tr>
